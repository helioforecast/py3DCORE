...
if __name__ == "__main__":
    t_launch = datetime.datetime(2023, 5, 17, 2, tzinfo=datetime.timezone.utc)

    t_s = datetime.datetime(2023, 5, 19, 2, tzinfo=datetime.timezone.utc)
    t_e = t_s + datetime.timedelta(hours=22)
    
    t_fit =  [
        datetime.datetime(2023, 5, 19, 8, tzinfo=datetime.timezone.utc),
        datetime.datetime(2023, 5, 19, 10, tzinfo=datetime.timezone.utc)
    ]
...
#         3: b_t          magnetic field strength at center
    ...
    output = 'dscovr15052023_heeq_512_forecast_1/'
    ...
    fitter.add_observer("DSCOVR", t_fit, t_s, t_e, custom_data = False)
